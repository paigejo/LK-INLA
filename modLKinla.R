...
fitLKINLAKenyaDat = function(dat=NULL, dataType=c("mort", "ed"), 
  ...
  c(fitLKINLAStandard2(obsCoords=obsCoords, obsValues=obsValues, predCoords=predPts, nu=nu, seed=seed, nLayer=nLayer, NC=NC, nBuffer=nBuffer, priorPar=priorPar, 
                       ...
                       strategy=strategy, fastNormalize=fastNormalize, 
                       predictionType=predictionType, significanceCI=significanceCI, printVerboseTimings=printVerboseTimings, 
                       nPostSamples=nPostSamples, family=family, obsNs=obsNs, clusterEffect=clusterEffect, latInfo=latInfo, 
                       initialEffectiveRange=initialEffectiveRange, initialAlphas=initialAlphas, effRangeRange=effRangeRange, predClusterI=predClusterI, 
